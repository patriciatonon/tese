...
\begin{figure}[htb!]
	...
	\label{fig:aerofolio2d-geometria}
\end{figure}


\begin{figure}[!htb]
	\centering
	\subfloat[Discretização da malha global (IGA) e local(MEF)]{\includegraphics[scale=1.5,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/MeshCoarseFine.pdf}}\\
	\subfloat[Discretização próxima ao aerofólio]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.8]{Imagens/Cap6/DetalheFine.pdf}}
...
\begin{figure}[htb!]
	\centering 
	{\includegraphics[scale=1.5,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/MalhaCoarseFEM4.pdf}}	
	\caption{Aerofólio 2D: Malha Global (MEF) }
	\label{fig:aerofolio2d_malhaglobalmef}
\end{figure}


\begin{figure}[htb!]
	\centering 
	{\includegraphics[scale=1.5,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/MalhaMono.pdf}}	
...
\begin{figure}[htb!]
	\centering
	\subfloat[Domínio total ]{\includegraphics[scale=1.55,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/pressaoStatic.pdf}}\\
	\subfloat[Domínio próximo ao aerofólio]{\includegraphics[trim=0 0 0 0,clip=true,scale=1.4]{Imagens/Cap6/pressaoStaticZoom.pdf}}
	\caption{Aerofólio 2D: Campo de pressão em $t=32$}
...
\begin{figure}[htb!]
	\centering
	\subfloat[Domínio total ]{\includegraphics[scale=1.55,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/velocidadeStatic.pdf}}\\
	\subfloat[Domínio próximo ao aerofólio]{\includegraphics[trim=0 0 0 0,clip=true,scale=1.4]{Imagens/Cap6/velocidadeStaticZoom.pdf}}
	\caption{Aerofólio 2D: Campo de  em $t=32$}
...
\begin{figure}[htb!]
	\centering
	\subfloat[$t = 8.04 $]{\includegraphics[scale=1.00,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/vel804.pdf}} \
	\subfloat[$t = 8.22 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=1.0]{Imagens/Cap6/vel822.pdf}}\\
	\subfloat[$t = 8.38 $]{\includegraphics[scale=1.00,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/vel838.pdf}} \
	\subfloat[$t = 8.72 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=1.0]{Imagens/Cap6/vel872.pdf}}\\
	\subfloat[$t = 9.04 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=1.0]{Imagens/Cap6/vel904.pdf}}
...
\begin{figure}[htb!]
	\centering
	\subfloat[$t = 8.04 $]{\includegraphics[scale=1.00,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/press804.pdf}} \
	\subfloat[$t = 8.22 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=1.0]{Imagens/Cap6/press822.pdf}}\\
	\subfloat[$t = 8.38 $]{\includegraphics[scale=1.00,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/press838.pdf}} \
	\subfloat[$t = 8.72 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=1.0]{Imagens/Cap6/press872.pdf}}\\
	\subfloat[$t = 9.04 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=1.0]{Imagens/Cap6/press904.pdf}}
