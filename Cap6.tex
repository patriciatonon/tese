...
Na Figura \ref{fig:aerofolio_detalheLocal} pode-se observar em vermelho os elementos que fazem parte da zona de colagem. A espessura da zona de colagem foi definida como $0,2$, compreendendo 628 elementos triangulares quadráticos e 1428 nós. A constante do operador de acoplamento $L^{2}$ foi definida como $k_{0} = 10$. 
...
Nas Figuras \ref{fig:aerofolio_velocidade} e \ref{fig:aerofolio_pressao} estão apresentados os campos de velocidade e pressão respectivamente para o período de um ciclo. 
...
O monomodelo emprega uma malha com 12438 elementos triangulares quadráticos e 25188 elementos \textcolor{red}{Um desses deve ser o número de nós. Corrija.}. As discretizações global e local para o método Arlequin são as mesmas do problema da \autoref{capitulo:Cap6:Exemplos:NACA0012}, incluindo a quantidade de elementos na zona de colagem.
...
Nas Figura \ref{fig:aerofolioMov_velocidade} e \ref{fig:aerofolioMov_pressao} são apresentados os campos de velocidade e pressão em diferentes instantes dentro de um ciclo do movimento oscilatório prescrito.
