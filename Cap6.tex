...
Com intuito de superar as dificuldades encontrados com a técnica de partição de domínios apresentada no Cap. \ref{capitulo:Cap5}, neste capítulo será apresentado o método multiescala Arlequin que permite também levar em conta efeitos localizados através do uso de um modelo local mais refinado superposto a um modelo global com discretização mais grosseira. No método Arlequin, o processo é realizado através do cruzamento e colagem entre os modelos em uma zona de colagem através da utilização de um operador de acoplamento.
...
O  método de Arlequin, de acordo com \citeonline{DhiaR:2005}, é baseado em três principais ideias (ver Fig. \ref{fig:dominioArlequin}):
...
A função ponderadora para os modelos (etapa 3) é  determinada conforme Eq. \refeq{eq:funcPondeArleq}. Além disso, a função ponderadora ($\arlequinWF$), para os modelos local e global, foi definida como uma função linear nesse trabalho. 
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State Definição da função de ponderadora de acordo com Eq. \refeq{eq:funcPondeArleq};
...
\begin{figure}[!htb]
	\centering
	\subfloat[Discretização da malha global (IGA) e local (MEF)\label{fig:aerofolio_malhaArlequin}]{\includegraphics[scale=3.0,trim=0cm 1cm 0cm 0.6cm, clip=true]{Imagens/Cap6/aerofolio_malhaArlequin.pdf}}\\
...
\begin{figure}[htb!]
	\centering
	\subfloat[$T_n$]{\includegraphics[scale=0.1,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/aerofolio_velTn.pdf}} \ \
	\subfloat[$T_n + T_n/4$]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.1]{Imagens/Cap6/aerofolio_velTn4.pdf}} \\
	\subfloat[$T_n + T_n/2 $]{\includegraphics[scale=0.1,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/aerofolio_velTn2.pdf}} \ \
	\subfloat[$T_n + 3T_n/4$]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.1]{Imagens/Cap6/aerofolio_velTn34.pdf}} \\
	{\includegraphics[trim=0 0 0 0,clip=true,scale=0.4]{Imagens/Cap6/aerofolio_velLegenda.png}}
...
\begin{figure}[htb!]
	\centering
	\subfloat[$T_n$]{\includegraphics[scale=0.1,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/aerofolio_pressTn.pdf}} \ \
	\subfloat[$T_n + T_n/4$]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.1]{Imagens/Cap6/aerofolio_pressTn4.pdf}} \\
	\subfloat[$T_n + T_n/2 $]{\includegraphics[scale=0.1,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/aerofolio_pressTn2.pdf}} \ \
	\subfloat[$T_n + 3T_n/4$]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.1]{Imagens/Cap6/aerofolio_pressTn34.pdf}}\\
	{\includegraphics[trim=0 0.5cm 0 0cm,clip=true,scale=0.4]{Imagens/Cap6/aerofolio_pressLegenda.png}}
...
\begin{figure}[htb!]
	\centering
	\subfloat[$t = 8,0 $]{\includegraphics[scale=0.1,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/aerofolioMov_vel400.pdf}} \
	\subfloat[$t = 8,3 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.1]{Imagens/Cap6/aerofolioMov_vel415.pdf}}\\
	\subfloat[$t = 8,5 $]{\includegraphics[scale=0.1,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/aerofolioMov_vel425.pdf}} \
	\subfloat[$t = 8,8 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.1]{Imagens/Cap6/aerofolioMov_vel440.pdf}}\\
...
\begin{figure}[htb!]
	\centering
	\subfloat[$t = 8,0 $]{\includegraphics[scale=0.1,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/aerofolioMov_press400.pdf}} \
	\subfloat[$t = 8,3 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.1]{Imagens/Cap6/aerofolioMov_press415.pdf}}\\
	\subfloat[$t = 8,5 $]{\includegraphics[scale=0.1,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap6/aerofolioMov_press425.pdf}} \
	\subfloat[$t = 8,8 $]{\includegraphics[trim=0 0 0 0,clip=true,scale=0.1]{Imagens/Cap6/aerofolioMov_press440.pdf}}\\
