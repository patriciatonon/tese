...
%\renewcommand{\nomgroup}[1]{%
%	\item[\bfseries
%	\ifstrequal{#1}{A}{Capítulo 2 — Fundamentação Teórica}{%
%		\ifstrequal{#1}{B}{Capítulo 3 — Formulação Matemática}{%
%			\ifstrequal{#1}{C}{Capítulo 4 — Método Numérico}{}}%
%	}%
%	]%
%}
...
%\includepdf[pages=-, pagecommand={}, fitpaper=true]{referencias2.pdf}
