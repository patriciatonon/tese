...
\begin{figure}[!htbp]
	...
	\centering
	\subfloat[\label{fig:cav2d_elementos_zs_local} Malha Local]{\includegraphics[scale=1.4, trim=2cm 0.5cm 2cm 0.5cm, clip=true]{Imagens/Cap5/cav2d_elementos_zs_local.pdf}} 
	\subfloat[\label{fig:cav2d_elementos_zs_global} Malha Global ]{\includegraphics[scale=1.4,trim=2cm 0.5cm 2cm 0.5cm, clip=true]{Imagens/Cap5/cav2d_elementos_zs_global.pdf}}
	\legend{Fonte: Elaborada pela autora}
\end{figure}
