...
Embora o problema possua caráter bidimensional, para fins de verificação do código, adota-se discretização isoparamétrica 3D com cinco \textit{patches} e um total de 17640 pontos de controle e 4800 células, conforme pode ser observado na Figura~\ref{fig:degrau_malha} em um plano $y_1\times$$y_2$. Na \autoref{tab:degrau_discretização_patches} apresenta-se o número de pontos de controle em cada direção paramétrica para cada \textit{patch}. 
