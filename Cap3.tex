...
\begin{figure}[!htbp]
	...
	\centering
	\subfloat[\label{fig:NURBS_curva_transProj}Projeção transformativa:  \textit{B-Spline}]{\includegraphics[scale=0.44,trim=0cm 0.0cm 0cm 0cm, clip=true]{Imagens/Cap3/NURBS_curva_projetiva.pdf}} 
...
\begin{figure}[!htbp]
	\caption{Cilindro: malha de células físicas - plano $y_1$$y_2$ }
	\centering
...
\begin{figure}[!htbp]
	\caption{Cilindro: campo de pressão para $\Reynolds = 1000$ - plano $y_1$$y_2$}
	\centering
...
Considera-se condição de aderência nas paredes paralelas aos planos $y_1$$y_3$ e $y_2$$y_3$ com $\velocity = 0$, enquanto as paredes paralelas ao plano $y_1$$y_2$ são consideradas lisas, com apenas $u_3=0$. Na entrada prescreve-se o perfil parabólico para $u_1$ dado por:
\begin{align}
...
Por fim, na Figura~\ref{fig:degrau_campos_pressao} é possível observar os campos de pressão para todos os números de Reynolds simulados.
