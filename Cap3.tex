...
\begin{figure}[!t]
	...
	\caption{Obtenção da circunferência}
...
\begin{figure}[!t]
	...
	\caption{Obtenção da superfície}
...
\begin{figure}[!htb]
	\centering
	\subfloat[Geometria e condições de contorno\label{fig:cilindro_geometria3d}]{\includegraphics[scale=0.6,trim=0cm 0cm 0cm 0cm, clip=true]{Imagens/Cap3/cilindro_geometria3d.pdf}}\\
	\subfloat[Discretização espacial\label{fig:cilindro_malha3d}]{\includegraphics[trim=0cm 0cm 0cm 0cm,clip,scale=1.2]{Imagens/Cap3/cilindro_malha.pdf}}
...
\begin{figure}[htb!]
	...
	\caption{Cilindro: Campos de velocidade para $\Reynolds = 1000$}
...
\begin{figure}[htb!]
	...
	\caption{Cilindro: Campos de pressão para $\Reynolds = 1000$}
