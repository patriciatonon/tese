...
%Sobre técnicas de superposição de modelo
%
%
%Desenvolvimento de técnica multiescala local/global estabilizada para análise de interação fluido-estrutura
...
\renewcommand{\nomgroup}[1]{%
	\ifthenelse{\equal{#1}{C}}{\item[\textbf{Capítulo \ref{capitulo:Cap1} - \nameref{capitulo:Cap1} }]}{
}}
