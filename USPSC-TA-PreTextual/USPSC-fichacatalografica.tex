	...
	\begin{tabular}{|p{0.9cm} p{8.7cm}|}
		\hline
		 ...
		 \imprimircutter & 
		  ...
		  & \\ 
		  & \hspace{0.4cm}1. Interação fluido-estrutura. 2. Análise Isogeométrica. 3.Método dos Elementos
		  Finitos. 4. Método Arlequin. 5. Descrição lagrangiana-euleriana arbitrária. I. \imprimirorientadorficha. 
		   II. Título. \\
