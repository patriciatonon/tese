...
%\nomenclature[B,02]{$t$}{Instante de tempo arbitrário;}
%\nomenclature[B,03]{$\density$}{Massa específica do fluido;}
%\nomenclature[B,04]{$V$}{Volume de um volume de controle infinitesimal;}
...
%\nomenclatura[B,08]{$\cauchyStress$}{Tensor de tensões de Cauchy de componentes $\sigma_ij$ com $i,j = 1,2,3$;}
...
%\nomenclature[B,16]{$n_{sd}$}{Dimensão espacial;}
...
%\nomenclature[B,24]{$\Omega_0$}{Domínio inicial ou material do escoamento do fluido;}
%\nomenclature[B,25]{$\mathbf{x}$}{Vetor das coordenadas dos pontos materiais de um ponto arbitrário;}
%\nomenclature[B,26]{$\pos$}{Vetor das coordenadas atuais de um ponto arbitrário;}
%\nomenclature[B,27]{$\Omega_{\bar{x}}$}{Domínio de referência do escoamento do fluido;}
%\nomenclature[B,28]{$\posAle$}{Vetor das coordenadas de referência de um ponto arbitrário;}
%\nomenclature[B,29]{$\mathbf{f}(\mathbf{x},t)$}{Função mudança de configuração do domínio material para o domínio espacial;}
%\nomenclature[B,30]{$\mathbf{\bar{f}}(\mathbf{\bar{x}},t)$}{Função mudança de configuração do domínio de referência para o domínio espacial;}
%\nomenclature[B,31]{$\mathfrak{f}(\mathbf{x},t)$}{Função mudança de configuração do domínio material para o domínio de referência;}	
%\nomenclature[B,32]{$\velocityALE$}{Velocidade dos pontos de referência;}
%\nomenclature[B,33]{$\mathbf{F}$}{Matriz jacobiana da função de mapeamento $\mathbf{f}(\mathbf{x},t)$;}
%\nomenclature[B,34]{$\mathbf{\bar{F}}$}{Matriz jacobiana da função de mapeamento $\mathbf{\bar{f}}(\mathbf{\bar{x}},t)$;}
%\nomenclature[B,35]{$\mathfrak{F}$}{Matriz jacobiana da função de mapeamento $\mathfrak{f}(\mathbf{x},t)$;}
...
%\nomenclature[B,44]{$\domain^{e}$}{Domínio computacional de um elemento finito;}
%\nomenclature[B,45]{$\nel$}{Número de subdomínios do domínio discreto;}
%\nomenclature[B,46]{$N_nos$}{Número de nós ou pontos de controle do domínio discreto;}
...
%\nomenclature[B,49]{$N$}{Função de forma da discretização do domínio;}
...
%\nomenclature[B,56]{$\NNSM$}{Resíduo do vetor discreto da equação da quantidade de movimento;}
%\nomenclature[B,57]{$\NNSC$}{Resíduo do vetor discreto da equação da continuidade;}
...
%\nomenclature[B,82]{$u_n$}{Velocidade do escoamento na direção normal ao contorno;}
%\nomenclature[B,83]{$F_L, F_D$}{Forças de sustentação e arrasto, respectivamente;}
%\nomenclature[B,84]{$C_L, C_D$}{Coeficiente de sustentação e arrasto, respectivamente;}
%\nomenclature[B,85]{$\Strouhal$}{Número de Strouhal;}
%\nomenclature[B,86]{$f_V$}{Frequência de desprendimento dos vórtices;}
...
\begin{figure}[htb!]
	\centering
	\subfloat[$T_n$]{\includegraphics[scale=0.20,trim=10cm 5cm 10cm 6cm, clip=true]{Imagens/Cap2/vel2030.pdf}}
	\subfloat[$T_n + T_n/6$]{\includegraphics[trim=10cm 5cm 10cm 6cm,clip=true,scale=0.20]{Imagens/Cap2/vel2040.pdf}} \\
	\subfloat[$T_n + T_n/3$]{\includegraphics[scale=0.20,trim=10cm 5cm 10cm 6cm, clip=true]{Imagens/Cap2/vel2050.pdf}}
	\subfloat[$T_n + T_n/2$]{\includegraphics[trim=10cm 5cm 10cm 6cm,clip=true,scale=0.20]{Imagens/Cap2/vel2060.pdf}} \\
	\subfloat[$T_n + 2T_n/3$]{\includegraphics[scale=0.20,trim=10cm 5cm 10cm 6cm, clip=true]{Imagens/Cap2/vel2070.pdf}}
	\subfloat[$T_n + 5T_n/6$]{\includegraphics[trim=10cm 5cm 10cm 6cm,clip=true,scale=0.20]{Imagens/Cap2/vel2080.pdf}} \\
...
\begin{figure}[htb!]
	\centering
	\subfloat[$T_n$]{\includegraphics[scale=0.20,trim=10cm 6cm 10cm 6cm, clip=true]{Imagens/Cap2/press2030.pdf}}
	\subfloat[$T_n + T_n/6$]{\includegraphics[trim=10cm 6cm 10cm 6cm,clip=true,scale=0.20]{Imagens/Cap2/press2040.pdf}} \\
	\subfloat[$T_n + T_n/3$]{\includegraphics[scale=0.20,trim=10cm 6cm 10cm 6cm, clip=true]{Imagens/Cap2/press2050.pdf}}
	\subfloat[$T_n + T_n/2$]{\includegraphics[trim=10cm 6cm 10cm 6cm,clip=true,scale=0.20]{Imagens/Cap2/press2060.pdf}} \\
	\subfloat[$T_n + 2T_n/3$]{\includegraphics[scale=0.20,trim=10cm 6cm 10cm 6cm, clip=true]{Imagens/Cap2/press2070.pdf}}
	\subfloat[$T_n + 5T_n/6$]{\includegraphics[trim=10cm 6cm 10cm 6cm,clip=true,scale=0.20]{Imagens/Cap2/press2080.pdf}} \\
