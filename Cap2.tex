...
\begin{algorithm}
	\caption{Algoritmo para problemas da Dinâmica dos Fluidos Computacional}
	\label{alg:fluid}
	\begin{algorithmic}[1]
...
\begin{figure}[!htbp]
	\caption{Cavidade quadrada: perfis de velocidade adimensionalizados - plano $y_1$$y_2$}
	\centering
...
Os campos de velocidade e de pressão para a situação estacionária são apresentados na Figura~\ref{fig:cavidade_vel} e na Figura~\ref{fig:cavidade_press}, respectivamente. Ressalta-se que para a simulação, por se tratar de um problema com todos os contornos com condição de Dirichlet impostos, a pressão torna-se indefinida. Por esse motivo, prescreveu-se pressão $\press = \press_{\infty} = 0\text{,}0$ no canto superior direito da cavidade. 

\begin{figure}[!htbp]
	\caption{Cavidade quadrada: campo de velocidade -  plano $y_1$$y_2$}
	\centering
...
\begin{figure}[!htbp]
	\caption{Cavidade quadrada: campo de pressão - plano $y_1$$y_2$}
	\centering
